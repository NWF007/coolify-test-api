			...
			<div className="max-w-md w-full space-y-8 animate-fade-in">
				<div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/20 p-8 relative overflow-hidden">
					...
					<div className="mt-8 pt-6 border-t border-gray-200 relative z-10">
						<p className="text-sm text-gray-600 mb-4 text-center font-medium">Test Accounts:</p>
						<div className="grid grid-cols-2 gap-3">
							...
							>
								<div className="flex items-center justify-center space-x-2">
									<div className="w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-white text-xs font-bold">B</div>
									<span>Bob</span>
								</div>
							</button>
						</div>
